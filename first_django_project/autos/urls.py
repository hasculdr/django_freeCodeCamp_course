...
urlpatterns = [
    ...
    path('add_auto/', views.CreateAuto.as_view(), name='add_auto'),
    path('edit_auto/<int:pk>/', views.UpdateAuto.as_view(), name='edit_auto'),
    path('delete_auto/<int:pk>/', views.DeleteAuto.as_view(), name='delete_auto'),
]
